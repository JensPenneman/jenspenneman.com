...
describe("buildJsonLd", () => {
  ...
  const ld = buildJsonLd(cvData, "nl-BE", new URL("/photo.jpg", base), base);
  ...
  it("is a ProfilePage wrapping a Person, with a shared Person id across locales", () => {
    ...
    const fr = buildJsonLd(cvData, "fr-BE", new URL("/photo.jpg", base), base);
  ...
  it("dates the profile from the content, not from the render", () => {
    ...
    const later = buildJsonLd(cvData, "nl-BE", new URL("/photo.jpg", base), base);
  ...
  it("names a country as the nationality, not a demonym", () => {
    ...
    const en = buildJsonLd(cvData, "en-GB", new URL("/photo.jpg", base), base);
